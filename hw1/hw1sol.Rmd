...
**Observation:** 4 variables are selected by Cp criterion. It includes Agriculture, Education, Catholic, and Infant.Mortality.
...
```{r}
par(mfrow = c(2, 2))
termplot(plmodi, partial.resid = TRUE, terms = 1)
termplot(plmodi, partial.resid = TRUE, terms = 2)
termplot(plmodi, partial.resid = TRUE, terms = 3)
termplot(plmodi, partial.resid = TRUE, terms = 4)
```
